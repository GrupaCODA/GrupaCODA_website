...
const ContactForm = () => {
  ...
  const InputStyle = styled.input`
    ...
    &:focus {
      ...
      -webkit-box-shadow: 0 10px 20px -4px rgba(26, 26, 26, 0.8);
      -moz-box-shadow: 0 10px 20px -4px rgba(26, 26, 26, 0.8);
      box-shadow: 0 10px 20px -4px rgba(26, 26, 26, 0.8);
    }
    ...
    <ContactFormStyled className="contact">
      ...
      <FooterStyle>
        ...
        <div>
          ...
          <AnchorStyle>627 279 00 25</AnchorStyle>
        </div>
      </FooterStyle>
    </ContactFormStyled>
  );
